--[[
  @author bfut
  @version 1.0
  @description bfut_Unselect items outside time selection
  @about
    HOW TO USE:
      1) Run the script.
...
for i = COUNT_SEL_ITEMS - 1, 0, -1 do
  ...
  if pos + reaper.GetMediaItemInfo_Value(item, "D_LENGTH") - ORIGINAL_TIMESEL_START <= 0 or
...
reaper.Undo_EndBlock2(0, "bfut_Unselect items outside time selection", -1)
