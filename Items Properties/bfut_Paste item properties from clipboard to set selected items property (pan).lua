--[[
  @author bfut
  @version 1.0
  @description bfut_Paste item properties from clipboard to set selected items property (pan)
  @about
...
reaper.Undo_EndBlock2(0, "bfut_Paste item properties from clipboard to set selected items property (pan).lua", -1)