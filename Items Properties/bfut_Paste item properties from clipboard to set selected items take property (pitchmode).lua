--[[
  @author bfut
  @version 1.6
  @description bfut_Paste item properties from clipboard to set selected items take property (pitchmode)
  @about
...
reaper.Undo_EndBlock2(0, "bfut_Paste item properties from clipboard to set selected items take property (pitchmode)", -1)