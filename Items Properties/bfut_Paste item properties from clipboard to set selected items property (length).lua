--[[
  @author bfut
  @version 1.1
  @description bfut_Paste item properties from clipboard to set selected items property (length)
  @about
...
reaper.Undo_EndBlock2(0, "bfut_Paste item properties from clipboard to set selected items property (length).lua", -1)