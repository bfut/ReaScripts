--[[
  @author bfut
  @version 1.5
  @description bfut_Paste item properties from clipboard to set selected items property (lowpassfade)
  @about
...
reaper.Undo_EndBlock2(0, "bfut_Paste item properties from clipboard to set selected items property (lowpassfade).lua", -1)